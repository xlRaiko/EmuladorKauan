...
public class Constants {
    ...
    static {
        ...
        if ((value = "MAX_VALUE".equalsIgnoreCase(property2 = System.getProperty("gnu.trove.no_entry.short", "0")) ? Short.MAX_VALUE : ("MIN_VALUE".equalsIgnoreCase(property2) ? Short.MIN_VALUE : (int)Short.valueOf(property2).shortValue())) > Short.MAX_VALUE) {
        ...
        if ((value = "MAX_VALUE".equalsIgnoreCase(property2 = System.getProperty("gnu.trove.no_entry.char", "\u0000")) ? 65535 : ("MIN_VALUE".equalsIgnoreCase(property2) ? 0 : property2.toCharArray()[0])) > 65535) {
            value = 65535;
        } else if (value < 0) {
            value = 0;
        }
