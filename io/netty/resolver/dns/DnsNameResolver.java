...
extends InetNameResolver {
    ...
    extends ChannelInboundHandlerAdapter {
                    ...
                    channel.pipeline().addLast(new ChannelInboundHandlerAdapter(){
                        ...
                        public void channelRead(ChannelHandlerContext ctx, Object msg) {
                            ...
                            if ((foundCtx = DnsNameResolver.this.queryContextManager.get(res.sender(), queryId)) == tcpCtx) {
                                ...
                                logger.warn("{} Received a DNS response with an unexpected ID: {}", (Object)channel, (Object)queryId);
                            }
                        }
        ...
        @Override
        public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
            logger.warn("{} Unexpected exception: ", (Object)ctx.channel(), (Object)cause);
        }
    }
}
