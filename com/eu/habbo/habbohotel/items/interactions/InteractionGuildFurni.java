...
public class InteractionGuildFurni
extends InteractionDefault {
    ...
    public void serializeExtradata(ServerMessage serverMessage) {
        ...
        if (guild != null) {
            ...
            serverMessage.appendString(Emulator.getGameEnvironment().getGuildManager().getSymbolColor((int)guild.getColorOne()).valueA);
            serverMessage.appendString(Emulator.getGameEnvironment().getGuildManager().getBackgroundColor((int)guild.getColorTwo()).valueA);
        } else {
