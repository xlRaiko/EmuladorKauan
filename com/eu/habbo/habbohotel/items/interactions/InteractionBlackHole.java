...
public class InteractionBlackHole
extends InteractionGate {
    ...
    public void onPlace(Room room) {
        ...
        holesCountProgress = owner == null ? AchievementManager.getAchievementProgressForHabbo(this.getUserId(), holeCountAchievement) : owner.getHabboStats().getAchievementProgress(holeCountAchievement);
