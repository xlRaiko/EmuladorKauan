...
extends InteractionDefault {
    ...
    public void onClick(GameClient client, Room room, Object[] objects) throws Exception {
        if (client != null && this.getUserId() == client.getHabbo().getHabboInfo().getId()) {
            ...
            int effectId = -1;
            if (client.getHabbo().getHabboInfo().getGender().equals((Object)HabboGender.M) && this.getBaseItem().getEffectM() > 0) {
                effectId = this.getBaseItem().getEffectM();
            }
            if (client.getHabbo().getHabboInfo().getGender().equals((Object)HabboGender.F) && this.getBaseItem().getEffectF() > 0) {
