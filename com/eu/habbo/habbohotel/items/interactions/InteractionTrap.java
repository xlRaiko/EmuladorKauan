...
extends InteractionDefault {
    ...
    public void onWalkOn(RoomUnit roomUnit, Room room, Object[] objects) throws Exception {
        if (!this.getExtradata().equals("0")) {
            ...
            if (roomUnit != null && (this.getBaseItem().getEffectF() > 0 || this.getBaseItem().getEffectM() > 0) && roomUnit.getRoomUnitType().equals((Object)RoomUnitType.USER) && habbo != null) {
