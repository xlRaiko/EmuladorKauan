...
extends HabboItem {
    ...
    public void onClick(GameClient client, Room room, Object[] objects) throws Exception {
        ...
        if (client != null && RoomLayout.tilesAdjecent(room.getLayout().getTile(this.getX(), this.getY()), client.getHabbo().getRoomUnit().getCurrentLocation()) && !this.getExtradata().equalsIgnoreCase("-1")) {
