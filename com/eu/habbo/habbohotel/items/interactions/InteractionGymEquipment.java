...
public class InteractionGymEquipment
extends InteractionEffectTile
implements ICycleable {
    ...
    public boolean canWalkOn(RoomUnit roomUnit, Room room, Object[] objects) {
        return this.roomUnitId == -1 && super.canWalkOn(roomUnit, room, objects) && (roomUnit.getRoomUnitType().equals((Object)RoomUnitType.USER) || roomUnit.getRoomUnitType().equals((Object)RoomUnitType.BOT));
    }
    ...
    public void onWalkOn(RoomUnit roomUnit, Room room, Object[] objects) throws Exception {
        ...
        if (roomUnit.getRoomUnitType() == RoomUnitType.USER && (habbo = room.getHabbo(roomUnit)) != null) {
    ...
    public void cycle(Room room) {
        int timestamp;
        Habbo habbo;
        if (this.roomUnitId != -1 && (habbo = room.getHabboByRoomUnitId(this.roomUnitId)) != null && (timestamp = Emulator.getIntUnixTimestamp()) - this.startTime >= 120) {
    ...
    public void setRotation(int rotation) {
        ...
        if (this.forceRotation() && this.roomUnitId != -1 && (room = Emulator.getGameEnvironment().getRoomManager().getRoom(this.getRoomId())) != null && (roomUnit = this.getCurrentRoomUnit(room)) != null) {
