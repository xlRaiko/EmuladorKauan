...
public class InteractionEffectGate
extends InteractionDefault
implements ConditionalGate {
    private static final List<Integer> defaultAllowedEnables = new ArrayList<Integer>(Arrays.asList(114, 115, 116, 117, 118, 135));
    ...
    public boolean canWalkOn(RoomUnit roomUnit, Room room, Object[] objects) {
        ...
        if (!customparams.isEmpty()) {
            return Arrays.asList(customparams.split(";")).contains(Integer.valueOf(roomUnit.getEffectId()).toString());
        }
