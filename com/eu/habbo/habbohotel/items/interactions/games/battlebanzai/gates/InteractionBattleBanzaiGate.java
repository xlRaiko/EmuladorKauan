...
public class InteractionBattleBanzaiGate
extends InteractionGameGate {
    ...
    public boolean canWalkOn(RoomUnit roomUnit, Room room, Object[] objects) {
        return room.getGame(BattleBanzaiGame.class) == null || ((BattleBanzaiGame)room.getGame(BattleBanzaiGame.class)).state.equals((Object)GameState.IDLE);
    }
    ...
    public void onWalkOn(RoomUnit roomUnit, Room room, Object[] objects) throws Exception {
        ...
        if (game == null) {
            game = (BattleBanzaiGame)BattleBanzaiGame.class.getDeclaredConstructor(Room.class).newInstance(room);
            room.addGame(game);
        }
        if ((team = game.getTeamForHabbo(room.getHabbo(roomUnit))) != null) {
