...
public class InteractionFreezeBlock
extends HabboItem {
    ...
    public void onClick(GameClient client, Room room, Object[] objects) throws Exception {
        ...
        for (HabboItem i : items) {
            if (!(i instanceof InteractionFreezeTile) || item != null && !(i.getZ() <= item.getZ())) continue;
            item = i;
        }
        if (item != null) {
    ...
    public void onWalkOn(RoomUnit roomUnit, Room room, Object[] objects) throws Exception {
        ...
        FreezeGame game = (FreezeGame)room.getGame(FreezeGame.class);
        if (game == null || !game.state.equals((Object)GameState.RUNNING)) {
            return;
        }
