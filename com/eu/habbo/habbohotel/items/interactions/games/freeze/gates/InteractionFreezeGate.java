...
public class InteractionFreezeGate
extends InteractionGameGate {
    ...
    public boolean canWalkOn(RoomUnit roomUnit, Room room, Object[] objects) {
        return room.getGame(FreezeGame.class) == null || ((FreezeGame)room.getGame(FreezeGame.class)).state.equals((Object)GameState.IDLE);
    }
    ...
    public void onWalkOn(RoomUnit roomUnit, Room room, Object[] objects) throws Exception {
        ...
        if (game == null) {
            game = (FreezeGame)FreezeGame.class.getDeclaredConstructor(Room.class).newInstance(room);
            room.addGame(game);
        }
