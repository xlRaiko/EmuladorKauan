...
public class InteractionEffectTile
extends InteractionPressurePlate {
    ...
    public void onWalkOn(RoomUnit roomUnit, Room room, Object[] objects) throws Exception {
        ...
        } else if (roomUnit.getRoomUnitType() == RoomUnitType.BOT && (bot = room.getBot(roomUnit)) != null) {
            this.giveEffect(room, roomUnit, bot.getGender());
        }
    }

    private void giveEffect(Room room, RoomUnit roomUnit, HabboGender gender) {
        if (gender.equals((Object)HabboGender.M)) {
