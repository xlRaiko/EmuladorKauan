...
public class InteractionPetDrink
extends InteractionDefault {
    ...
    public void onWalkOn(RoomUnit roomUnit, Room room, Object[] objects) throws Exception {
        ...
        if ((pet = room.getPet(roomUnit)) != null && pet.getPetData().haveDrinkItem(this) && pet.levelThirst >= 35) {
            pet.clearPosture();
    ...
    private void change(Room room, int amount) {
        ...
        if ((state += amount) > this.getBaseItem().getStateCount() - 1) {
