...
public class WiredConditionTeamGreenCount
extends WiredConditionSuperWired {
    public WiredConditionTeamGreenCount(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredConditionTeamGreenCount(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
