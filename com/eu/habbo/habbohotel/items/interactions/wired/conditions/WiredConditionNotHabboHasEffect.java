...
public class WiredConditionNotHabboHasEffect
extends InteractionWiredCondition {
    private static final WiredConditionType type = WiredConditionType.ACTOR_WEARS_BADGE;
    ...
    public boolean saveData(WiredSettings settings) {
        this.effectId = settings.getStringParam().matches("^[0-9]+$") ? Integer.valueOf(settings.getStringParam()) : 0;
        return true;
    }
