...
public class WiredConditionNotInTeam
extends InteractionWiredCondition {
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
        ...
        if (habbo != null) {
            return habbo.getHabboInfo().getGamePlayer() == null || !habbo.getHabboInfo().getGamePlayer().getTeamColor().equals((Object)this.teamColor);
        }
        return true;
    }
