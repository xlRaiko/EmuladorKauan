...
public class WiredConditionFurniHaveHabbo
extends InteractionWiredCondition {
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
        ...
        return this.items.stream().allMatch(item -> {
            ...
            return habbos.stream().anyMatch(character -> occupiedTiles.contains(character.getRoomUnit().getCurrentLocation())) || bots.stream().anyMatch(character -> occupiedTiles.contains(character.getRoomUnit().getCurrentLocation())) || pets.stream().anyMatch(character -> occupiedTiles.contains(character.getRoomUnit().getCurrentLocation()));
        });
    }
    ...
    public void loadWiredData(ResultSet set, Room room) throws SQLException {
        block3: {
            ...
            block2: {
                ...
                if (!wiredData.startsWith("{")) break block2;
            ...
            if (data.length < 1) break block3;
            for (String s : items = data[1].split(";")) {
