...
public class WiredConditionMatchStatePosition
...
implements InteractionWiredMatchFurniSettings {
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
        ...
        for (WiredMatchFurniSetting setting : this.settings) {
            ...
            if (item != null) {
                ...
                if (!this.direction || setting.rotation == item.getRotation()) continue;
                return false;
            }
            s.add(setting);
        }
    ...
    public THashSet<WiredMatchFurniSetting> getSettings() {
        return this.settings;
    }

    @Override
    public String getWiredData() {
        return WiredHandler.getGsonBuilder().create().toJson(new JsonData(this.state, this.position, this.direction, new ArrayList<WiredMatchFurniSetting>(this.settings)));
    }
