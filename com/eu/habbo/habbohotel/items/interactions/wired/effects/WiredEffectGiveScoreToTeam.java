...
public class WiredEffectGiveScoreToTeam
extends InteractionWiredEffect {
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
        for (Game game : room.getGames()) {
            GameTeam team;
            int c;
            if (game == null || !game.state.equals((Object)GameState.RUNNING) || (c = this.startTimes.get(game.getStartTime())) >= this.count || (team = game.getTeam(this.teamColor)) == null) continue;
