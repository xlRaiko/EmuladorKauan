...
public class WiredEffectRemoveScoreCustom
extends InteractionWiredEffect {
    ...
    public WiredEffectRemoveScoreCustom(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredEffectRemoveScoreCustom(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
    ...
    public void serializeWiredData(ServerMessage message, Room room) {
        ...
        message.appendInt(0);
        message.appendInt(0);
        message.appendInt(WiredEffectRemoveScoreCustom.type.code);
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
        ...
        if (this.message.length() > 0) {
            ...
            WiredHighscoreDataEntry entry = new WiredHighscoreDataEntry(itemId, userIds, score - 1, true, Emulator.getIntUnixTimestamp());
            ...
            if (!hasEntry) {
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            statement.setString(2, "" + habbo.getHabboInfo().getId());
                            statement.setInt(3, score - 1);
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            statement.setInt(1, score - 1);
                            statement.setInt(2, Emulator.getIntUnixTimestamp());
                            statement.setInt(3, itemId);
                            statement.setString(4, "" + habbo.getHabboInfo().getId());
                            statement.executeUpdate();
                        }
                        finally {
                            if (statement != null) {
