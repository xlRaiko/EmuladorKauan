...
public class WiredEffectTeleport
extends InteractionWiredEffect {
    ...
    public static void teleportUnitToTile(RoomUnit roomUnit, RoomTile tile, boolean isAnimation) {
        ...
        Emulator.getThreading().run(new RoomUnitTeleport(roomUnit, room, tile.x, tile.y, tile.getStackHeight() + (tile.state == RoomTileState.SIT ? -0.5 : 0.0), roomUnit.getEffectId()), WiredHandler.TELEPORT_DELAY);
    }
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
        ...
        if (!this.items.isEmpty()) {
            ...
            WiredEffectTeleport.teleportUnitToTile(roomUnit, room.getLayout().getTile(item2.getX(), item2.getY()), isNotAnimation);
            return true;
        }
        return false;
    }
