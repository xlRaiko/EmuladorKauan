...
public class WiredEffectFreezeUserEffect
extends InteractionWiredEffect {
    public static final WiredEffectType type = WiredEffectType.SHOW_MESSAGE;
    protected String message = "";

    public WiredEffectFreezeUserEffect(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredEffectFreezeUserEffect(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
    ...
    public void serializeWiredData(ServerMessage message, Room room) {
        ...
        message.appendInt(0);
        message.appendInt(0);
        message.appendInt(WiredEffectFreezeUserEffect.type.code);
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
        ...
        if (roomUnit != null && (habbo = room.getHabbo(roomUnit)) != null) {
            ...
            habbo.whisper(Emulator.getTexts().getValue("wired.effect.userfreeze.congelado"), RoomChatMessageBubbles.ALERT);
        }
        return false;
    }
