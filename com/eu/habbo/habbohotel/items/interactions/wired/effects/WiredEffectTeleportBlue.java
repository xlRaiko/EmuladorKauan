...
public class WiredEffectTeleportBlue
extends InteractionWiredEffect {
    public static final WiredEffectType type = WiredEffectType.TELEPORT;
    private static final GameTeamColors teamColor = GameTeamColors.BLUE;
    protected List<HabboItem> items = new ArrayList<HabboItem>();

    public WiredEffectTeleportBlue(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredEffectTeleportBlue(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
        ...
        if (!this.items.isEmpty()) {
            ...
            WiredEffectTeleportBlue.teleportUnitToTile(room, room.getLayout().getTile(item2.getX(), item2.getY()), isNotAnimation);
            return true;
        }
        return false;
    }
