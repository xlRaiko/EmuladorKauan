...
public class WiredEffectSitUser
extends InteractionWiredEffect {
    public static final WiredEffectType type = WiredEffectType.RESET_TIMERS;
    private int delay = 0;

    public WiredEffectSitUser(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredEffectSitUser(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
