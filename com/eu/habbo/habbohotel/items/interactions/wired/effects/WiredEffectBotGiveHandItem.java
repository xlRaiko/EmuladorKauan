...
public class WiredEffectBotGiveHandItem
extends InteractionWiredEffect {
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
        ...
        if (habbo != null && bots.size() == 1) {
            ...
            tasks.add(() -> {
                if (roomUnit.getRoom() != null && roomUnit.getRoom().getId() == room.getId() && roomUnit.getCurrentLocation().distance(bot.getRoomUnit().getCurrentLocation()) < 2.0) {
