...
public class WiredEffectTeleportRed
extends InteractionWiredEffect {
    public static final WiredEffectType type = WiredEffectType.TELEPORT;
    private static final GameTeamColors teamColor = GameTeamColors.RED;
    protected List<HabboItem> items = new ArrayList<HabboItem>();

    public WiredEffectTeleportRed(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredEffectTeleportRed(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
        ...
        if (!this.items.isEmpty()) {
            ...
            WiredEffectTeleportRed.teleportUnitToTile(room, room.getLayout().getTile(item2.getX(), item2.getY()), isNotAnimation);
            return true;
        }
        return false;
    }
