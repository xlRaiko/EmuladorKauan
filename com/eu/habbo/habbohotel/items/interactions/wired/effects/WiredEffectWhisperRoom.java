...
public class WiredEffectWhisperRoom
extends InteractionWiredEffect {
    ...
    public void serializeWiredData(ServerMessage message, Room room) {
        ...
        message.appendInt(0);
        message.appendInt(0);
        message.appendInt(WiredEffectWhisperRoom.type.code);
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
        if (this.message.length() > 0 && roomUnit != null) {
            String msg = "";
            for (Habbo habbo : room.getHabbos()) {
                ...
                if (!habbo.getRoomUnit().isIdle()) continue;
