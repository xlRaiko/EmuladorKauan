...
public class WiredEffectLayUser
extends InteractionWiredEffect {
    public static final WiredEffectType type = WiredEffectType.RESET_TIMERS;
    private int delay = 0;

    public WiredEffectLayUser(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredEffectLayUser(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
