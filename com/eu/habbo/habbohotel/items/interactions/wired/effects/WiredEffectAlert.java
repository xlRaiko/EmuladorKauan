...
extends WiredEffectWhisper {
    ...
    public boolean execute(RoomUnit roomUnit, Room room, Object[] stuff) {
        ...
        if (habbo != null) {
            habbo.alert(this.message.replace("%online%", "" + Emulator.getGameEnvironment().getHabboManager().getOnlineCount()).replace("%username%", habbo.getHabboInfo().getUsername()).replace("%roomsloaded%", "" + Emulator.getGameEnvironment().getRoomManager().loadedRoomsCount()));
            return true;
        }
        return false;
    }
