...
public class WiredTriggerWalk
extends InteractionWiredTrigger {
    public static final WiredTriggerType type = WiredTriggerType.TO_WALK;
    private String username = "";

    public WiredTriggerWalk(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredTriggerWalk(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
