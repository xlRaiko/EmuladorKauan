...
public class EmptyBotsInventoryCommand
extends Command {
    ...
    public boolean handle(GameClient gameClient, String[] params) throws Exception {
        ...
        if (params.length >= 2 && params[1].equalsIgnoreCase(Emulator.getTexts().getValue("generic.yes"))) {
            ...
            if (habbo != null) {
                TIntObjectHashMap<Bot> bots = new TIntObjectHashMap<Bot>();
                ...
                bots.forEachValue(object -> {
                    Emulator.getGameEnvironment().getBotManager().deleteBot((Bot)object);
                    return true;
                });
