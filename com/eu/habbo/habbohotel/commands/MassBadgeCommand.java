        ...
        if (params.length == 2) {
            ...
            if (!badge.isEmpty()) {
                ...
                for (Map.Entry<Integer, Habbo> set : Emulator.getGameEnvironment().getHabboManager().getOnlineHabbos().entrySet()) {
                    ...
                    if (!habbo.isOnline() || habbo.getInventory() == null || habbo.getInventory().getBadgesComponent() == null || habbo.getInventory().getBadgesComponent().hasBadge(badge) || (b = BadgesComponent.createBadge(badge, habbo)) == null) continue;
