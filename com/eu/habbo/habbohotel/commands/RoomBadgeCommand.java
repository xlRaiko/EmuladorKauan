        ...
        if (params.length == 2) {
            ...
            if (!badge.isEmpty()) {
                ...
                for (Habbo habbo : gameClient.getHabbo().getRoomUnit().getRoom().getHabbos()) {
                    if (!habbo.isOnline() || habbo.getInventory() == null || habbo.getInventory().getBadgesComponent() == null || habbo.getInventory().getBadgesComponent().hasBadge(badge)) continue;
