...
ISerialize {
        ...
        try (Connection connection = Emulator.getDatabase().getDataSource().getConnection();
            ...
            try (ResultSet set = statement.executeQuery();){
                while (set.next()) {
                    ...
                    ForumThreadComment.cacheComment(foundComment);
                }
            }
        }
    ...
    public static ForumThreadComment create(ForumThread thread, Habbo poster, String message) throws Exception {
        ...
        try (Connection connection = Emulator.getDatabase().getDataSource().getConnection();
             PreparedStatement statement = connection.prepareStatement("INSERT INTO `guilds_forums_comments`(`thread_id`, `user_id`, `message`, `created_at`) VALUES (?, ?, ?, ?);", 1);){
            ...
            if (!set.next()) return createdComment;
