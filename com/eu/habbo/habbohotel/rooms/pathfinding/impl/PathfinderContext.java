...
public class PathfinderContext {
    ...
    public PathfinderContext(Room room, RoomTile newTile, RoomTile goalLocation, RoomUnit roomUnit, boolean isWalkthroughRetry, boolean canMoveDiagonally, RoomTile doorTile, boolean allowWalkthrough, Map<Long, RoomTile> tileCache) {
    ...
    public static PathfinderContext buildContext(Room room, RoomTile newTile, RoomTile goalLocation, RoomUnit roomUnit, boolean isWalkthroughRetry) {
        return new PathfinderContext(room, newTile, goalLocation, roomUnit, isWalkthroughRetry, room.moveDiagonally(), room.getLayout().getDoorTile(), room.isAllowWalkthrough(), new HashMap<Long, RoomTile>());
    }
