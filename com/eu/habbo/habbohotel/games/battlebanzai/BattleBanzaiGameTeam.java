...
public class BattleBanzaiGameTeam
extends GameTeam {
    ...
    public void removeMember(GamePlayer gamePlayer) {
        ...
        if (room != null && room.getRoomSpecialTypes() != null) {
            for (InteractionGameGate interactionGameGate : room.getRoomSpecialTypes().getBattleBanzaiGates().values()) {
                interactionGameGate.updateState(game, 5);
            }
        }
    }
}
