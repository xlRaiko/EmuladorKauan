...
implements Runnable {
    ...
    public MarketPlaceOffer(HabboItem item, int price, Habbo habbo) {
        ...
        try (Connection connection = Emulator.getDatabase().getDataSource().getConnection();
             PreparedStatement statement = connection.prepareStatement("INSERT INTO marketplace_items (item_id, user_id, price, timestamp, state) VALUES (?, ?, ?, ?, ?)", 1);){
    ...
    public int getType() {
        ...
        return this.baseItem.getType().equals((Object)FurnitureType.WALL) ? 2 : 1;
    }
