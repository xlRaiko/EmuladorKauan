...
implements ISerialize {
    ...
    public void serialize(ServerMessage message, int hcExpireTimestamp) {
        ...
        long secondsTotal = seconds = (long)this.days * 86400L;
        int totalYears = (int)Math.floor((double)((int)seconds) / 3.21408E7);
        int totalMonths = (int)Math.floor((double)((int)(seconds -= (long)(totalYears * 32140800))) / 2678400.0);
        int totalDays = (int)Math.floor((double)((int)(seconds -= (long)(totalMonths * 2678400))) / 86400.0);
        message.appendInt((int)secondsTotal / 86400 / 31);
        message.appendInt((int)(seconds -= (long)totalDays * 86400L));
        message.appendBoolean(false);
        message.appendInt((int)seconds);
        hcExpireTimestamp = (int)((long)hcExpireTimestamp + secondsTotal);
        Calendar cal = Calendar.getInstance();
        cal.setTimeZone(TimeZone.getTimeZone("UTC"));
        cal.setTimeInMillis((long)hcExpireTimestamp * 1000L);
