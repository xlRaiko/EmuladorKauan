...
public class GivePixels
extends RCONMessage<JSONGivePixels> {
    ...
    public void handle(Gson gson, JSONGivePixels object) {
        ...
        if (habbo != null) {
            ...
            try (Connection connection = Emulator.getDatabase().getDataSource().getConnection();
                 PreparedStatement statement = connection.prepareStatement("UPDATE users_currency SET users_currency.amount = users_currency.amount + ? WHERE users_currency.user_id = ? AND users_currency.type = 0");){
