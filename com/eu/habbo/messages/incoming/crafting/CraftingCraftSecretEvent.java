...
public class CraftingCraftSecretEvent
extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (craftingAltar != null && (altar = Emulator.getGameEnvironment().getCraftingManager().getAltar(craftingAltar.getBaseItem())) != null) {
            THashSet<HabboItem> habboItems = new THashSet<HabboItem>();
