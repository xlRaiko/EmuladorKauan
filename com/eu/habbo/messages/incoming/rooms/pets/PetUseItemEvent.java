    ...
    public void handle() throws Exception {
        ...
        if (pet instanceof HorsePet) {
            if (item.getBaseItem().getName().toLowerCase().startsWith("horse_dye")) {
                ...
                int newHairdye = 48;
                newHairdye = splittedHairdye == 0 ? -1 : (splittedHairdye == 1 ? 1 : (splittedHairdye >= 13 && splittedHairdye <= 17 ? 68 + splittedHairdye : (newHairdye += splittedHairdye)));
                ...
                newHairstyle = splittedHairstyle == 0 ? -1 : (newHairstyle += splittedHairstyle);
            ...
            } else if (item.getBaseItem().getName().startsWith("mnstr_rebreed") && ((MonsterplantPet)pet).isFullyGrown() && !((MonsterplantPet)pet).canBreed() && (item.getBaseItem().getName().equalsIgnoreCase("mnstr_rebreed") && ((MonsterplantPet)pet).getRarity() <= 5 || item.getBaseItem().getName().equalsIgnoreCase("mnstr_rebreed_2") && ((MonsterplantPet)pet).getRarity() >= 6 && ((MonsterplantPet)pet).getRarity() <= 8 || item.getBaseItem().getName().equalsIgnoreCase("mnstr_rebreed_3") && ((MonsterplantPet)pet).getRarity() >= 9)) {
