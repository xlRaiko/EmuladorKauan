...
public class MovePetEvent
extends MessageHandler {
    @Override
    public void handle() throws Exception {
        Room room;
        Pet pet = this.client.getHabbo().getHabboInfo().getCurrentRoom().getPet(this.packet.readInt());
        if (pet != null && (room = this.client.getHabbo().getHabboInfo().getCurrentRoom()) != null && room.hasRights(this.client.getHabbo()) && pet.getRoomUnit() != null) {
