...
public class RequestRoomHeightmapEvent
extends MessageHandler {
    @Override
    public void handle() throws Exception {
        Room room;
        if (this.client.getHabbo().getHabboInfo().getLoadingRoom() > 0 && (room = Emulator.getGameEnvironment().getRoomManager().loadRoom(this.client.getHabbo().getHabboInfo().getLoadingRoom())) != null && room.getLayout() != null) {
