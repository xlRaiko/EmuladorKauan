...
public class YoutubeRequestStateChange
extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        switch (state.ordinal()) {
            ...
            case 3: {
                ...
                tv.autoAdvance = Emulator.getThreading().run(new YoutubeAdvanceVideo(tv), (long)(tv.currentVideo.getDuration() - tv.offset) * 1000L);
        ...
        if (state == YoutubeState.PREVIOUS || state == YoutubeState.NEXT) {
            ...
            tv.autoAdvance = Emulator.getThreading().run(new YoutubeAdvanceVideo(tv), (long)tv.currentVideo.getDuration() * 1000L);
            tv.startedWatchingAt = Emulator.getIntUnixTimestamp();
            tv.offset = 0;
            tv.playing = true;
            room.updateItem(tv);
    ...
    public static enum YoutubeState {
        PREVIOUS(0),
        NEXT(1),
        PAUSE(2),
        RESUME(3);
        ...
        private YoutubeState(int state) {
            this.state = state;
        }
