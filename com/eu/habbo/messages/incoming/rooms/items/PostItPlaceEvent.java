...
extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (room != null && (room.hasRights(this.client.getHabbo()) || !room.getRoomSpecialTypes().getItemsOfType(InteractionStickyPole.class).isEmpty()) && (item = this.client.getHabbo().getInventory().getItemsComponent().getHabboItem(itemId)) instanceof InteractionPostIt) {
