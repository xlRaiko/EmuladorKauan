...
public class RedeemClothingEvent
extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (this.client.getHabbo().getHabboInfo().getCurrentRoom() != null && this.client.getHabbo().getHabboInfo().getCurrentRoom().hasRights(this.client.getHabbo()) && (item = this.client.getHabbo().getHabboInfo().getCurrentRoom().getHabboItem(itemId)) != null && item.getUserId() == this.client.getHabbo().getHabboInfo().getId() && item instanceof InteractionClothing) {
            ...
            if (clothing != null) {
                ...
                LOGGER.error("[Catalog] No definition in catalog_clothing found for clothing name {}. Could not redeem clothing!", (Object)item.getBaseItem().getName());
            }
        }
    }
}
