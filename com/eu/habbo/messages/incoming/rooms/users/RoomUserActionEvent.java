...
public class RoomUserActionEvent
extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (room != null) {
            ...
            if (this.client.getHabbo().getRoomUnit().getCacheable().get("control") != null && (habbo = (Habbo)this.client.getHabbo().getRoomUnit().getCacheable().get("control")).getHabboInfo().getCurrentRoom() != room) {
            ...
            if ((action = this.packet.readInt().intValue()) == 5) {
