...
public class RoomUserDanceEvent
extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (danceId >= 0 && danceId <= 5 && this.client.getHabbo().getRoomUnit().isInRoom()) {
            ...
            if (this.client.getHabbo().getRoomUnit().getCacheable().get("control") != null && (habbo = (Habbo)this.client.getHabbo().getRoomUnit().getCacheable().get("control")).getHabboInfo().getCurrentRoom() != this.client.getHabbo().getHabboInfo().getCurrentRoom()) {
