...
public class RoomUserLookAtPoint
extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (habbo.getRoomUnit().getCacheable().get("control") != null && (habbo = (Habbo)this.client.getHabbo().getRoomUnit().getCacheable().get("control")).getHabboInfo().getCurrentRoom() != this.client.getHabbo().getHabboInfo().getCurrentRoom()) {
        ...
        if (!(roomUnit = habbo.getRoomUnit()).canWalk()) {
            return;
        }
