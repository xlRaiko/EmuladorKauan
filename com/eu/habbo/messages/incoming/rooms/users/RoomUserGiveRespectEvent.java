...
public class RoomUserGiveRespectEvent
extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (this.client.getHabbo().getHabboStats().respectPointsToGive > 0) {
            ...
            if (Emulator.getPluginManager().isRegistered(UserRespectedEvent.class, false) && Emulator.getPluginManager().fireEvent(new UserRespectedEvent(target, this.client.getHabbo())).isCancelled()) {
                return;
            }
