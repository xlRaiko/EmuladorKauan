...
public class GuildForumThreadsMessagesEvent
extends MessageHandler {
    @Override
    public void handle() throws Exception {
        boolean isGuildAdministrator;
        ...
        boolean bl = isGuildAdministrator = guild.getOwnerId() == this.client.getHabbo().getHabboInfo().getId() || member.getRank().equals((Object)GuildRank.ADMIN);
