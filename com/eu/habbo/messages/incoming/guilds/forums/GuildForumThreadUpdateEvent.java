...
public class GuildForumThreadUpdateEvent
extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        boolean bl = isAdmin = guild.getOwnerId() == this.client.getHabbo().getHabboInfo().getId() || member.getRank().type < GuildRank.MEMBER.type;
        ...
        boolean bl2 = pinChanged = isPinned != thread.isPinned();
        if (pinChanged) {
