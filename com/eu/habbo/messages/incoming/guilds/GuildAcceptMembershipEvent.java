...
public class GuildAcceptMembershipEvent
extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (guild != null) {
            ...
            if (userId == this.client.getHabbo().getHabboInfo().getId() || guild.getOwnerId() == this.client.getHabbo().getHabboInfo().getId() || groupMember.getRank().equals((Object)GuildRank.ADMIN) || groupMember.getRank().equals((Object)GuildRank.OWNER) || this.client.getHabbo().hasPermission(Permission.ACC_GUILD_ADMIN)) {
                if (habbo != null) {
