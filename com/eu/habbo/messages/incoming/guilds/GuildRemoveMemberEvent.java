...
public class GuildRemoveMemberEvent
extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (userId == this.client.getHabbo().getHabboInfo().getId() || guild.getOwnerId() == this.client.getHabbo().getHabboInfo().getId() || member.getRank().equals((Object)GuildRank.OWNER) || member.getRank().equals((Object)GuildRank.ADMIN) || this.client.getHabbo().hasPermission(Permission.ACC_GUILD_ADMIN)) {
