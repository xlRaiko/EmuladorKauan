...
public class GuildConfirmRemoveMemberEvent
extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (guild != null) {
            ...
            if (userId == this.client.getHabbo().getHabboInfo().getId() || guild.getOwnerId() == this.client.getHabbo().getHabboInfo().getId() || member != null && member.getRank().equals((Object)GuildRank.OWNER) || member.getRank().equals((Object)GuildRank.ADMIN) || this.client.getHabbo().hasPermission(Permission.ACC_GUILD_ADMIN)) {
