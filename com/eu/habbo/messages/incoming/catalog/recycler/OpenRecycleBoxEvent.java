...
public class OpenRecycleBoxEvent
    ...
    public void handle() throws Exception {
        ...
        if (room.getOwnerId() == this.client.getHabbo().getHabboInfo().getId() || this.client.getHabbo().hasPermission(Permission.ACC_ANYROOMOWNER)) {
            ...
            if (item instanceof InteractionGift) {
                ...
                Emulator.getThreading().run(new OpenGift(item, this.client.getHabbo(), room), item.getBaseItem().getName().contains("present_wrap") ? 1000L : 0L);
            } else {
            ...
            if (item.getRoomId() == 0) {
                ...
                if (roomLayout != null && (roomTile = roomLayout.getTile(item.getX(), item.getY())) != null) {
                    z = roomTile.z;
                }
