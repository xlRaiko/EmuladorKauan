...
public class RequestWearingBadgesEvent
extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        if (habbo == null || habbo.getHabboInfo() == null || habbo.getInventory() == null || habbo.getInventory().getBadgesComponent() == null) {
            ...
            WiredHandler.handle(WiredTriggerType.TAG, habbo.getRoomUnit(), habbo.getHabboInfo().getCurrentRoom(), new Object[]{habbo.getHabboStats().cacheTag});
            WiredHandler.handle(WiredTriggerType.CLICK_TO_USER, habbo.getRoomUnit(), habbo.getHabboInfo().getCurrentRoom(), new Object[]{habbo.getHabboInfo().getUsername()});
        }
    }
}
