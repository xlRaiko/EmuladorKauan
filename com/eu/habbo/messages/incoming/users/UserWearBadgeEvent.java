...
public class UserWearBadgeEvent
extends MessageHandler {
    ...
    public void handle() throws Exception {
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            if (badgeId.length() == 0 || (badge = this.client.getHabbo().getInventory().getBadgesComponent().getBadge(badgeId)) == null || updatedBadges.contains(badge) || usedSlots.contains(slot)) continue;
            usedSlots.add(slot);
            badge.setSlot(slot);
