...
public class ConfirmChangeNameEvent
extends MessageHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(ConfirmChangeNameEvent.class);
    public static final List<String> changingUsernames = new ArrayList<String>(2);
    ...
    public void handle() throws Exception {
        ...
        if (name.equals(this.client.getHabbo().getHabboStats().changeNameChecked)) {
            ...
            if (habboInfo == null) {
                List<String> list = changingUsernames;
                synchronized (list) {
                ...
                List<String> list2 = changingUsernames;
                synchronized (list2) {
                ...
                try (Connection connection = Emulator.getDatabase().getDataSource().getConnection();
                     PreparedStatement statement = connection.prepareStatement("INSERT INTO namechange_log (user_id, old_name, new_name, timestamp) VALUES (?, ?, ?, ?) ");){
                ...
                this.client.sendResponse(new ChangeNameCheckResultComposer(5, name, new ArrayList<String>()));
            }
        }
    }
}
