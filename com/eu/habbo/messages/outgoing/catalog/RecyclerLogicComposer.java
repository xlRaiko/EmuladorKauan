...
public class RecyclerLogicComposer
extends MessageComposer {
    ...
    protected ServerMessage composeInternal() {
        ...
        for (Map.Entry<Integer, THashSet<Item>> map : Emulator.getGameEnvironment().getCatalogManager().prizes.entrySet()) {
            ...
            this.response.appendInt(Integer.valueOf(Emulator.getConfig().getValue("hotel.ecotron.rarity.chance." + String.valueOf(map.getKey()))));
