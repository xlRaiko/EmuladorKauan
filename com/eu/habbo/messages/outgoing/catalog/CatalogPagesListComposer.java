...
public class CatalogPagesListComposer
extends MessageComposer {
    ...
    private void append(CatalogPage category) {
        ...
        this.response.appendString(category.getCaption() + (String)(this.hasPermission ? " (" + category.getId() + ")" : ""));
        ...
        Object object = pagesList.iterator();
        while (object.hasNext()) {
            CatalogPage page = (CatalogPage)object.next();
            this.append(page);
        }
    }
