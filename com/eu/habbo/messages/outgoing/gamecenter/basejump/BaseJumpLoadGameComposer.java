...
public class BaseJumpLoadGameComposer
extends MessageComposer {
    ...
    protected ServerMessage composeInternal() {
        ...
        if (this.game == 3) {
            ...
            this.response.appendString(Emulator.getConfig().getValue("username") + "\tArcturus Morningstar 3.5.4 \t" + this.client.getHabbo().getHabboInfo().getId() + "\t" + this.client.getHabbo().getHabboInfo().getUsername() + "\t" + this.client.getHabbo().getHabboInfo().getLook() + "\t" + this.client.getHabbo().getHabboInfo().getCredits() + "\t" + FASTFOOD_KEY);
