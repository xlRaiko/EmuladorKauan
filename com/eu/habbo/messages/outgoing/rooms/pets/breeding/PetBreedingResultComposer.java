...
public class PetBreedingResultComposer
extends MessageComposer {
    ...
    protected ServerMessage composeInternal() {
        ...
        double avgLevel = ((float)this.petOne.pet.getLevel() + (float)this.petTwo.pet.getLevel()) / 2.0f;
