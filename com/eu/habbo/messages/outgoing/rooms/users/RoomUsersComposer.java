...
public class RoomUsersComposer
extends MessageComposer {
    ...
    protected ServerMessage composeInternal() {
        block5: {
            block7: {
                block6: {
                    block4: {
                        ...
                        if (this.habbo == null) break block4;
                        ...
                        String name = "";
                        if (this.habbo.getHabboStats().guild != 0 && (g = Emulator.getGameEnvironment().getGuildManager().getGuild(this.habbo.getHabboStats().guild)) != null) {
                            name = g.getName();
                        }
                    ...
                    if (this.habbos == null) break block6;
                    ...
                    for (Habbo habbo : this.habbos) {
                        ...
                        this.response.appendInt(habbo.getHabboStats().guild != 0 ? habbo.getHabboStats().guild : -1);
                        String name = "";
                        if (habbo.getHabboStats().guild != 0 && (g = Emulator.getGameEnvironment().getGuildManager().getGuild(habbo.getHabboStats().guild)) != null) {
                            name = g.getName();
                        }
                        this.response.appendString(name);
                        this.response.appendString("");
            ...
            if (this.bots == null) break block5;
