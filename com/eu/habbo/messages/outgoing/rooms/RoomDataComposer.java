...
extends MessageComposer {
    ...
    protected ServerMessage composeInternal() {
        ...
        this.response.appendBoolean(this.room.hasGuild() && Emulator.getGameEnvironment().getGuildManager().getGuildMember(this.room.getGuildId(), this.habbo.getHabboInfo().getId()) != null);
