...
public class ModToolUserInfoComposer
extends MessageComposer {
    ...
    protected ServerMessage composeInternal() {
        ...
        try {
            ...
            if (Emulator.getConfig().getBoolean("hotel.sanctions.enabled") && (modToolSanctionItems = (modToolSanctionItemsHashMap = Emulator.getGameEnvironment().getModToolSanctions().getSanctions(this.set.getInt("user_id"))).get(this.set.getInt("user_id"))) != null && modToolSanctionItems.size() > 0) {
