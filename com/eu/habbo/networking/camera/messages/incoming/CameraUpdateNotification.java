...
public class CameraUpdateNotification
extends CameraIncomingMessage {
    ...
    public void handle(Channel client) throws Exception {
        ...
        if (type == 0) {
            LOGGER.info("Camera update: {}", (Object)message);
        } else if (type == 1) {
            LOGGER.warn("Camera update: {}", (Object)message);
        } else if (type == 2) {
            LOGGER.error("Camera update: {}", (Object)message);
        }
        if (alert) {
