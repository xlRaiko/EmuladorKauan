...
public class RCONServerHandler
extends ChannelInboundHandlerAdapter {
    ...
    public void channelRegistered(ChannelHandlerContext ctx) throws Exception {
        ...
        for (String s : Emulator.getRconServer().allowedAdresses) {
            if (!s.equalsIgnoreCase(adress)) continue;
            return;
        }
        ctx.channel().close();
        LOGGER.warn("RCON Remote connection closed: {}. IP not allowed!", (Object)adress);
    }
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        try {
            ...
            LOGGER.error("Unknown RCON Message: {}", (Object)key);
        }
        catch (Exception e) {
            LOGGER.error("Invalid RCON Message: {}", (Object)message);
            e.printStackTrace();
        }
