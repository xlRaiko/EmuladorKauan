    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
        ...
        if (Emulator.getConfig().getBoolean("debug.mode")) {
            if (cause instanceof NotSslRecordException) {
                ...
                LOGGER.error("Disconnecting client, reason {}", (Object)cause.getMessage());
            } else if (cause instanceof SSLHandshakeException) {
                LOGGER.error("URL Request error from source {}", (Object)ctx.channel().remoteAddress());
                ...
                LOGGER.error("There was an illegal SSL request from (X-forwarded-for/CF-Connecting-IP has not being injected yet!) {}", (Object)ctx.channel().remoteAddress());
            } else if (cause instanceof SSLException) {
                LOGGER.error("SSL Problem: {}{}", (Object)cause.getMessage(), (Object)cause);
            } else {
