...
implements Runnable {
    ...
    public void run() {
        if (this.room == this.habbo.getHabboInfo().getCurrentRoom()) {
            ...
            Emulator.getThreading().run(this, (long)iamapirate[this.index - 1].length() * 100L);
        }
    }
}
