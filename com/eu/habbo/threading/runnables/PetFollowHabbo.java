...
implements Runnable {
    ...
    public void run() {
        if (this.pet != null) {
            ...
            if (this.habbo != null && this.habbo.getRoomUnit() != null && this.pet.getRoomUnit() != null && (target = this.habbo.getHabboInfo().getCurrentRoom().getLayout().getTileInFront(this.habbo.getRoomUnit().getCurrentLocation(), Math.abs((this.habbo.getRoomUnit().getBodyRotation().getValue() + this.directionOffset + 4) % 8))) != null) {
