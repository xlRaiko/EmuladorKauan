...
implements Runnable {
    ...
    public void run() {
        ...
        if (rewardItem != null && (newItem = Emulator.getGameEnvironment().getItemManager().createItem(this.habboItem.allowAnyone() ? this.habbo.getHabboInfo().getId() : this.habboItem.getUserId(), rewardItem, 0, 0, "")) != null) {
