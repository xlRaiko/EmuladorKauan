...
public class ScramSha1SaslClientFactory
implements SaslClientFactory {
    private static final String[] SUPPORTED_MECHANISMS = new String[]{"MYSQLCJ-SCRAM-SHA-1"};

    @Override
    public SaslClient createSaslClient(String[] mechanisms, String authorizationId, String protocol, String serverName, Map<String, ?> props, CallbackHandler cbh) throws SaslException {
        for (String mech : mechanisms) {
            if (!mech.equals("MYSQLCJ-SCRAM-SHA-1")) continue;
            return new ScramSha1SaslClient(authorizationId, this.getUsername(authorizationId, cbh), this.getPassword(cbh));
        }
        return null;
    }
    ...
    private String getUsername(String authorizationId, CallbackHandler cbh) throws SaslException {
        ...
        try {
            String prompt = "MYSQLCJ-SCRAM-SHA-1 authentication id:";
    ...
    private String getPassword(CallbackHandler cbh) throws SaslException {
        ...
        try {
            String prompt = "MYSQLCJ-SCRAM-SHA-1 password:";
